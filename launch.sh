...
aws sns subscribe --topic-arn $Arn --protocol email --notification-endpoint nandini9590@gmail.com
aws sns set-topic-attributes --topic-arn $Arn --attribute-name DisplayName --attirbute-value mp2 
